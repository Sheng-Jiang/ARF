...
if china.empty:
    st.warning("No China data for this snapshot.")
    st.stop()
...
- **Froth flag ★**: D1 AND ROE < WACC (12% for China) AND P/S > 25
- A-shares fetched via Baostock; HK/ADR via yfinance
""")
